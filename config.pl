...
# System config
use constant ADMIN_PASS => 'adminpass';			# Admin password. For fucks's sake, change this.
use constant NUKE_PASS => 'adminpass';			# Password to nuke a board. Change this too, NOW!
use constant SECRET => 'OLOLLLdjsklahfasdfnfaslka;jhsfdpoivzxucyjksandfsakj;dlfhvzihux';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'Local image board';	# Name of this image board
